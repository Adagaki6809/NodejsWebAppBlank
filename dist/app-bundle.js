...
var App = /** @class */ (function (_super) {
    ...
    App.prototype.render = function () {
        return (React.createElement("div", null,
            React.createElement(Footer, { siteName: this.props.siteName, siteURL: this.props.siteURL }),
...
var Footer = /** @class */ (function (_super) {
    ...
    Footer.prototype.render = function () {
        var list = [];
        for (var i = 0; i < this.props.siteName.length; i++)
            list.push(React.createElement(Site, { siteName: this.props.siteName[i], siteURL: this.props.siteURL[0] }));
        return (React.createElement("div", { className: "footer", id: "footer" }, list));
    };
    return Footer;
}(React.Component));
...
var Site = /** @class */ (function (_super) {
    ...
    Site.prototype.render = function () {
        return (React.createElement("input", { type: "button", className: "footer-button", value: this.props.siteName, "data-url": this.props.siteURL }));
    };
    return Site;
}(React.Component));
exports.Site = Site;
var Post = /** @class */ (function (_super) {
    ...
    Post.prototype.render = function () {
        return (React.createElement("div", null,
            React.createElement("form", { method: "post", action: "/app/calc", onSubmit: "" },
                React.createElement("input", { type: "text", name: "first_name", value: "\u0412\u0432\u0435\u0434\u0438\u0442\u0435 \u0438\u043C\u044F", onClick: this.value = '' }),
                React.createElement("input", { type: "submit", value: "\u041E\u0442\u043F\u0440\u0430\u0432\u0438\u0442\u044C" }))));
    };
    return Post;
}(React.Component));
exports.Post = Post;
var siteName = ["Anison", "DTF", "empty", "3DNEWS", "Twitch"];
var siteURL = ["https://anison.fm"];
ReactDOM.render(React.createElement(App, { siteName: siteName, siteURL: siteURL }), document.getElementById('root'));
